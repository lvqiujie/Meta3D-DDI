...
def get_args():
    ...
    parser.add_argument('--num_class', default=2, type=int, help='..')
    parser.add_argument('--max_len', default=128, type=int, help='..')
    parser.add_argument('--emb_dim', default=64, type=int, required=False, help='..')
    parser.add_argument('--cutoff', default=10.0, type=float, required=False, help='..')
    parser.add_argument('--num_layers', default=6, type=int, required=False, help='..')
    parser.add_argument('--hidden_channels', default=128, type=int, required=False, help='..')
    parser.add_argument('--num_filters', default=128, type=int, required=False, help='..')
    parser.add_argument('--num_gaussians', default=50, type=int, required=False, help='..')
    parser.add_argument('--g_out_channels', default=64, type=int, required=False, help='..')
    parser.add_argument('--load_model_path', default=None, type=str, required=False, help='..')
    parser.add_argument('--save_log_path', default='default', type=str, required=False, help='..')
